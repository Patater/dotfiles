...
"
" Modified by Michael Torrie to be closer to the real desert scheme.
"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "eeeeee", "1d1d1d", "")
    ...
    call <SID>X("Folded", "ffd700", "5d5d5d", "")
    call <SID>X("FoldColumn", "d2b48c", "5d5d5d", "")
